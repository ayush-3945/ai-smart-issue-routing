# ⚡ CoalDarpan — Autonomous Incident Triage & Resolution Platform
...
**CoalDarpan** is an enterprise-grade autonomous incident triage and operations platform. It eliminates manual support triage by instantly analyzing incoming issues, classifying them into departments (`IT`, `HR`, `Finance`, `Operations`), calculating priority and confidence ratings (98%+), and forecasting 7-day workload surges in real-time.
...
<div align="center">
  ...
  <img src="./docs/screenshots/user-dashboard.png" alt="CoalDarpan User Incident Portal" width="100%" style="border-radius: 12px; border: 1px solid #1e293b;" />
  <br /><br />
  <p><strong>3. Enterprise Landing Page & Live Incident Dispatch Pipeline</strong></p>
  <img src="./docs/screenshots/landing-page.png" alt="CoalDarpan Landing Page" width="100%" style="border-radius: 12px; border: 1px solid #1e293b;" />
</div>
