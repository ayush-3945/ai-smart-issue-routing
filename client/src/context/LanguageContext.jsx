...
export const translations = {
  en: {
    ...
    raiseIssueSubtitle: 'Describe your problem. Google Gemini AI will instantly analyze, prioritize, and route it.',
    ...
    geminiExecutiveBrief: 'Gemini AI Executive Brief',
    confidence: 'Confidence',
    troubleshootingPlan: 'Gemini Instant Troubleshooting Plan',
    guidance: 'Guidance',
    ...
    geminiWorkloadPrediction: 'Gemini AI Workload & Surge Prediction (Next 7 Days)',
  ...
  hi: {
    ...
    raiseIssueSubtitle: 'अपनी समस्या का विवरण दें। Google Gemini AI तुरंत विश्लेषण कर संबंधित विभाग को सौंप देगा।',
    ...
    geminiExecutiveBrief: 'Gemini AI कार्यकारी सारांश',
    confidence: 'सटीकता',
    troubleshootingPlan: 'Gemini त्वरित समाधान कार्य योजना',
    ...
    geminiWorkloadPrediction: 'Gemini AI कार्यभार एवं उछाल भविष्यवाणी (अगले 7 दिन)',
